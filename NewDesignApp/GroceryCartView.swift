...
import UIKit
protocol GroceryOpenCartViewDelegate: AnyObject {
    func openCartView()
}
class GroceryCartView: UIView {
    var itemLbl = UILabel()
    ...
    override init(frame: CGRect) {
      ...
      private func setupView() {
        backgroundColor = .kgreen
         ...
         // itemLbl.text = "\(UtilsClass.getCurrencySymbol())\(GroceryCartData.shared.getAllPriceDeatils().subTotal)"
