...
import UIKit
import Lottie
class DineinHistoryVC: UIViewController {
...
let montharr = ["01","02","03","04","05","06","07","08","09","10","11","12"]
        ...
        WebServices.loadDataFromServiceWithBaseResponse(parameter: parameters, servicename: OldServiceType.getDineInOrders, forModelType: BookingHistoryResponse.self) { success in
            ...
            if self.dineInList.count == 0 {
                ...
                self.noDataFoundLbl.text = "You don't have any dineIn orders."
            }
...
extension DineinHistoryVC: UITableViewDelegate, UITableViewDataSource {
...
extension DineinHistoryVC: UIPickerViewDataSource, UIPickerViewDelegate {
...
extension DineinHistoryVC: LoginSuccessDelegate {
    func signupAction() {
...
extension DineinHistoryVC: SignupSuccessfullyDelegate {
